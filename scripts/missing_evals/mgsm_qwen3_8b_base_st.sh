...
#SBATCH --mem=64G
#SBATCH -J mgsm_qwen3_8b_base_st
#SBATCH -o /nethome/jhe478/flash/Soft-Thinking/logs/mgsm_qwen3_8b_base_st_%j.log

# Evaluate Qwen3-8B-Base on MGSM (Soft-Thinking)
