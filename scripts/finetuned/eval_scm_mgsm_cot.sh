...
#SBATCH -o logs/eval_scm_mgsm_cot_%j.log

# Evaluate SCM fine-tuned model on MGSM (CoT, no soft-thinking)
# Base: Qwen3-4B-Instruct-2507, SCM-GRPO checkpoint-50
...
echo "=========================================="
echo "Step 2: MGSM CoT Evaluation"
echo "=========================================="
